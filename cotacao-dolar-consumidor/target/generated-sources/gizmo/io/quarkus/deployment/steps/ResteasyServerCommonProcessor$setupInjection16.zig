// Class: io/quarkus/deployment/steps/ResteasyServerCommonProcessor$setupInjection16
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/ResteasyServerCommonProcessor$setupInjection16#deploy_0
    RETURN
    ** label2
